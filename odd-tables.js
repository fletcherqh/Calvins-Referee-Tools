...
oddTables.npcWizard = function (level, alignment) {
	...
	//Add potions; scrolls; etc.; make them more likely and wands/staves and rings less likely, respectively
	//OED version: sword, armor(+shield?), potion, misc.
	//default to +1, then half chance to increase by 1, repeating
...
// determine basic level derivatives 
	...
	output += alignment + " ";
	output += "EV" + level + " ";
	//output += "F" + levelFighter + "/M" + levelMagic + " "; (Josh Bear)
	output += "S:" + aStr + " ";
	output += "I:" + aInt + " ";
	output += "W:" + aWis + " ";
	output += "C:" + aCon + " ";
